...
export const fileUpload = async ({ file, ownerId, accountId, path }: UploadFileProps) => {
    ...
    try {
        ...
        const newFile = await databases.createDocument(appwriteConfig.databaseId,appwriteConfig.filesCollectionId,
            ID.unique(),
            fileDocument
...
export const deleteFile = async ({ fileId, bucketFileId, path }: DeleteFileProps ) => {
    ...
    try {
        const deletedFile = await databases.deleteDocument(appwriteConfig.databaseId,
            appwriteConfig.filesCollectionId,
            fileId,
        )
